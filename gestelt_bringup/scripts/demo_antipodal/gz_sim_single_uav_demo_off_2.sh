...
SESSION="gz_sim_single_uav_demo_off_2"
...
#####
CMD_0="
roslaunch --wait gestelt_bringup single_uav_sim.launch drone_id:=2 init_x:=-1.2 init_y:=2.07846
"

CMD_1="roslaunch --wait gestelt_bringup single_fake_map.launch drone_id:=2"

CMD_2="
roslaunch --wait gestelt_bringup single_ego_planner.launch drone_id:=2 init_x:=-1.2 init_y:=2.07846 POSE_TYPE:=3 SENSOR_TYPE:=1
"
